...
import { generateUniqueEmail } from "../utils/generate-email";

test.describe("Sing Up Page Tests - NaviJapan", () => {
  const baseUrl = "https://beta.navijapan.ai";
  ...
  test("Should signUp successfully with valid email, then verify signout flow", async ({
    page,
  }) => {
    ...
    await page
      .getByRole("checkbox", {
        name: "I want to receive updates about scholarships and programs",
      })
      .check();
